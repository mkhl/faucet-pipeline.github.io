...
export default function DefaultLayout({ title, subtitle, docTitle }, ...children) {
	return <html>
		<head>
			...
			<meta name="description" content="The no-nonsense asset pipeline for humans." />
		...
		<body>
			<header class="header">
				<div class="header-left">The no–nonsense asset pipeline for humans.</div>
				<div class="header-right">
					<img src="img/faucet_device_logotype_static-1024.png" alt="Faucet" class="header-logo" />
				</div>
			</header>
			<div class="grid">
				<aside class="aside">
			...
			<footer class="footer">
				<img src="img/logo_faucet_monochrome.svg" alt="faucet" class="footer-logo" />
